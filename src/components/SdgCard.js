            ...
            <div>
                <Link to={sdg.link} className='sdg-card'>
                    <svg width={100} height={100} viewBox='0 0 100 100'>
                        <circle class='bg' cx={cx} cy={cy} r={r} fill='none' stroke='#1a2c34' strokeOpacity='20%' strokeWidth={strokeWidth} />
                        <motion.circle
                            cx={cx}
                            cy={cy}
                            r={r}
                            ...
                            initial={{ strokeDashoffset: `calc(${circumference} - (0 / 100 * ${circumference}))` }}
                            animate={{ strokeDashoffset: `calc(${circumference} - (${sdg.description} / 100 * ${circumference}))` }}
